...
x_interp_lagrange_8 = np.linspace(-4, 4, 8)
y_interp_lagrange_8 = f_original(x_interp_lagrange_8)
interpolator_poli_8 = lagrange(x_interp_lagrange_8, y_interp_lagrange_8)
error_text_lagrange8 = calculate_errors(f_original(x_values_polinomic), interpolator_poli_8(x_values_polinomic))
...
ax1.plot(x_values_polinomic, interpolator_poli_8(x_values_polinomic), label='Interpolación', linestyle='--', color='red')
ax1.scatter(x_interp_lagrange_8, y_interp_lagrange_8, label='Puntos de Datos', color='black')
ax1.legend(fontsize='small', bbox_to_anchor=(1.05, 1), loc='upper left')
ax1.set_title('Lagrange con 8 puntos equiespaciados')
ax1.text(-4, np.min(f_original(x_values_polinomic)), error_text_polinomic, fontsize=5, va='bottom', ha='left', color='red',  bbox=dict(facecolor='white', alpha=0.5, edgecolor='black'))
ax1.set_xlabel('x')
ax1.set_ylabel('y')
ax1.legend()
ax1.grid(True)
...
ax2.set_xlabel('x')
ax2.set_ylabel('y')
ax2.set_title('Lagrange con 8 puntos de Chebyshev')
...
ax3.set_title('Lagrange con 10 puntos equiespaciados')
...
ax5.set_title('Lagrange con 15 puntos equiespaciados')
ax5.text(-4, np.min(f_original(x_values_polinomic))-8, error_text_lagrange15, fontsize=6, va='bottom', ha='left', color='red',  bbox=dict(facecolor='white', alpha=0.5, edgecolor='black'))
ax5.set_xlabel('x')
ax5.set_ylabel('y')
ax5.legend()
ax5.grid(True)
